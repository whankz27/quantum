        ...
        <div class="container" data-aos="fade-up" data-aos-delay="100">
            ...
            <div class="row gy-4 posts-list">
                ...
                <div class="col-xl-4 col-md-6">
                    ...
                    <!--        <img src="/img/loker/banner/dlpbanner.jpg" class="img-fluid" alt="">-->
                    <!--<span class="post-date">December 12</span>-->
                    <!--    </div>-->

                    <!--    <div class="post-content d-flex flex-column">-->

                    <!--        <h3 class="post-title">DIGITAL LEADERSHIP PROGRAM (DLP)-->
                    <!--        </h3>-->

                    <!--        <hr>-->

                    <!--        <a href="/dlp" class="readmore stretched-link justify-content-center"><span>CHECK REQUIREMENTS</span></a>-->
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="post-item position-relative h-100">
                        ...
                        <div class="post-img position-relative overflow-hidden">
                            <img src="assets/img/header_form.webp" class="img-fluid" alt="">
                            <!--<span class="post-date">December 12</span>-->
                        </div>

                        <div class="post-content d-flex flex-column">

                            <h3 class="post-title">REGULAR RECRUITMENT
                            </h3>

                            <hr>

                            <a href="reguler.php" class="readmore stretched-link justify-content-center"><span>CHECK
                                    REQUIREMENTS</span></a>
